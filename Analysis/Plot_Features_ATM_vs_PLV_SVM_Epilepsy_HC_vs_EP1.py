...
for f in freqbands:
    ...
    #  SubMatrix_T_T, SubMatrix_T_P, SubMatrix_T_O, \
    #  SubMatrix_P_P, SubMatrix_P_O, \
    #  SubMatrix_O_O, weights_estim_PLV_edges_2plot] = Lobes_Partition(weights_estim_PLV_edges, idx_F_DK, idx_M_DK, idx_P_DK, idx_T_DK, idx_O_DK)
    #
    # fig_edges_EP1, ax = plt.subplots(facecolor='white',
    #                                  subplot_kw=dict(polar=True))
    # _plot_connectivity_circle(
    #     con=weights_estim_PLV_edges_2plot, node_names=node_names, node_colors=Region_DK_color_by_lobes,
    #     colorbar=True,
    #     fontsize_names=7,  fontsize_title=9 ,
    #     node_angles=node_angles,
    #     colormap='Greys', facecolor='white', textcolor='black',
    ...
    #     path_figures_root +  'Connect_Features_HC_vs_EP1_Edges_PLV_fmin_'+str(fmin)+ '_fmax_'+ str(fmax) + '.png',
    #     dpi=600,
    #     facecolor='white')
...
features = {"df_weights_estim_ATM_edges_nodal_theta": df_weights_estim_ATM_edges_nodal['theta']['ROIs'].values,
            "df_weights_estim_ATM_nodal_theta": df_weights_estim_ATM_nodal['theta']['ROIs'].values,
            "df_weights_estim_PLV_edges_nodal_theta":df_weights_estim_PLV_edges_nodal['theta']['ROIs'].values,
            "df_weights_estim_PLV_nodal_theta": df_weights_estim_PLV_nodal['theta']['ROIs'].values,
            "df_weights_estim_ATM_edges_nodal_alpha": df_weights_estim_ATM_edges_nodal['alpha']['ROIs'].values,
            "df_weights_estim_ATM_nodal_alpha": df_weights_estim_ATM_nodal['alpha']['ROIs'].values,
            "df_weights_estim_PLV_edges_nodal_alpha":df_weights_estim_PLV_edges_nodal['alpha']['ROIs'].values,
            "df_weights_estim_PLV_nodal_alpha": df_weights_estim_PLV_nodal['alpha']['ROIs'].values,
            "df_weights_estim_ATM_edges_nodal_theta_alpha": df_weights_estim_ATM_edges_nodal['theta-alpha']['ROIs'].values,
            "df_weights_estim_ATM_nodal_theta_alpha": df_weights_estim_ATM_nodal['theta-alpha']['ROIs'].values,
            "df_weights_estim_PLV_edges_nodal_theta_alpha":df_weights_estim_PLV_edges_nodal['theta-alpha']['ROIs'].values,
            "df_weights_estim_PLV_nodal_theta_alpha": df_weights_estim_PLV_nodal['theta-alpha']['ROIs'].values,
            "df_weights_estim_ATM_edges_nodal_broad": df_weights_estim_ATM_edges_nodal['paper'][
                'ROIs'].values,
            "df_weights_estim_ATM_nodal_broad": df_weights_estim_ATM_nodal['paper']['ROIs'].values,
            "df_weights_estim_PLV_edges_nodal_broad": df_weights_estim_PLV_edges_nodal['paper'][
                'ROIs'].values,
            "df_weights_estim_PLV_nodal_broad": df_weights_estim_PLV_nodal['paper']['ROIs'].values,
            }
