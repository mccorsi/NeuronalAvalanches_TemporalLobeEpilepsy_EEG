...
def _build_df_ImCoh_from_scores(scores, ppl_name, nbSplit, zthresh_value, aval_duration_value, fmin, fmax, duration):
    ...
    pd_ImCoh_classif_res["zthresh"] = [zthresh_value] * len(ppl_ImCoh)
    pd_ImCoh_classif_res["val_duration"] = [aval_duration_value] * len(ppl_ImCoh)
...
Avg_ImCoh_EP1_HC = {"df_Avg_ImCoh_EP1_edges_nodal_theta_alpha": df_Avg_ImCoh_EP1_edges_nodal['theta-alpha']['ROIs'].values,
                  "df_Avg_ImCoh_EP1_edges_nodal_broad": df_Avg_ImCoh_EP1_edges_nodal['paper']['ROIs'].values,
                  "df_Avg_ImCoh_HC_edges_nodal_theta_alpha": df_Avg_ImCoh_HC_edges_nodal['theta-alpha']['ROIs'].values,
                  "df_Avg_ImCoh_HC_edges_nodal_broad": df_Avg_ImCoh_HC_edges_nodal['paper']['ROIs'].values,
                  "df_Avg_ImCoh_EP1_edges_nodal_alpha": df_Avg_ImCoh_EP1_edges_nodal['alpha']['ROIs'].values,
                  "df_Avg_ImCoh_EP1_edges_nodal_theta": df_Avg_ImCoh_EP1_edges_nodal['theta']['ROIs'].values,
                  "df_Avg_ImCoh_HC_edges_nodal_alpha": df_Avg_ImCoh_HC_edges_nodal['alpha']['ROIs'].values,
                  "df_Avg_ImCoh_HC_edges_nodal_theta": df_Avg_ImCoh_HC_edges_nodal['theta']['ROIs'].values
                  }
scipy.io.savemat(path_csv_root + 'Avg_ImCoh_EP1_HC.mat', Avg_ImCoh_EP1_HC)